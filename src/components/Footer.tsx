...
//         {/* BRAND & DISCLAIMER (The Warning Label) */}
...
//         {/* NAVIGATION LINKS */}
//         <div className="flex gap-12 font-mono uppercase tracking-[0.15em] text-[10px]">
//           <div className="flex flex-col gap-4 items-center md:items-start">
//             <span className="text-zinc-300 font-black mb-2 border-b border-red-900 pb-1">Protocol</span>
//             <a href="https://github.com/VishantJadhav/forgefi-frontend/blob/main/README.md" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">Docs / Litepaper</a>
//             <a href="https://explorer.solana.com/address/AyN3aAx2VJTSxJGaR5n9Ayhpa6inCAxaSGupxbGw1Rnz?cluster=devnet" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">Smart Contracts</a>
//             <a href="#" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">Global Leaderboard</a>
//           </div>
          
//           <div className="flex flex-col gap-4 items-center md:items-start">
//             <span className="text-zinc-300 font-black mb-2 border-b border-red-900 pb-1">Comm</span >
//             <a href="https://x.com/VishantJadhav7" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">X (Dev's X)</a>
//             <a href="https://discord.com/vishantjadhav_88391" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">Discord</a>
//             <a href="https://github.com/VishantJadhav/forgefi-frontend" className="text-zinc-600 hover:text-red-500 hover:translate-x-1 transition-all">Dev's GitHub</a>
//           </div>
//         </div>
//       </div>
      ...
      <div className="max-w-5xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center md:items-start gap-12">
        ...
        <div className="flex gap-12 font-mono uppercase tracking-[0.1em] text-xs">
          ...
          <div className="flex flex-col gap-4 items-center md:items-start">
            ...
            <a href="https://x.com/VishantJadhav7" target="_blank" rel="noreferrer" className="text-zinc-500 hover:text-red-500 hover:translate-x-1 transition-all">Dev's X</a>
